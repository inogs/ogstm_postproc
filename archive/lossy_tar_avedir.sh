...
echo "SYNOPSYS"
echo "lossy_tar_avedir.sh [ -i AVEDIR] [-o TARDIR ] [-n NCPUS] [ -v REF_VAR] [-s SIGNIFICANT_DIGITS ] "
...
mpirun -np $NCPUS python netcdf4_strong_compress.py -i ${INPUT_AVEDIR} -o ${ZIPPED_DIR} -l ave*nc -s $DIGITS
ANS=$?
