...
for VAR in   P_l  P1l    P2l    P3l    P4l ; do
   ...
   my_prex_or_die "python plot_timeseries_STD.py -v $VAR -i $SAT_VALID_DIR -o $VALIDATION_DIR/SAT/Fig4.2_Timeseries/offshore/${VAR} -c open_sea -s 20220101 -e 20250101"
   my_prex_or_die "python plot_timeseries_RMS_CORR.py -v $VAR -i $SAT_VALID_DIR -c open_sea -o $VALIDATION_DIR/SAT/Fig4.3_BiasRmsd/offshore/${VAR} -s 20220101 -e 20250101" # table4.1
   my_prex_or_die "python plot_timeseries_RMS_CORR.py -v $VAR -i $SAT_VALID_DIR -c coast -o $VALIDATION_DIR/SAT/Fig4.3_BiasRmsd/coast/${VAR} -s 20220101 -e 20250101"  # table4.2
