...
for VAR in   P_l  P1l    P2l    P3l    P4l kd490; do
   ...
   my_prex_or_die "cp $VALIDATION_DIR/SAT/Fig4.3_BiasRmsd/offshore/${VAR}/table4.1_${VAR}_${zone}.txt $VALIDATION_DIR/SAT/table4.1_offshore "
   my_prex_or_die "cp $VALIDATION_DIR/SAT/Fig4.3_BiasRmsd/coast/${VAR}/table4.1_${VAR}_${zone}.txt    $VALIDATION_DIR/SAT/table4.2_coast/table4.2_${VAR}_${zone}.txt "
