...
echo ""
echo "SYNOPSYS"
echo "check_daily_products_in_DU.sh [ -p productdir ] [ -t tmpfile ] [-b -bindir]  "
echo "EXAMPLE"
echo "check_daily_products_in_DU.sh -p /path/PROD/  -t tmp.txt -b bindir"
echo ""
}
