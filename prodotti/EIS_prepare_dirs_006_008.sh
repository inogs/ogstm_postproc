...
for YEAR in $(seq 2023 2028) ; do
	for group in bio car nut co2 plankton; do
	    dataset=cmems_mod_med_bgc-${group}_my_4.2km_P1D-m_202511
...
for YEAR in $(seq 2023 2028) ; do
        for group in  bio car nut co2 plankton; do
            dataset=cmems_mod_med_bgc-${group}_my_4.2km_P1M-m_202511
            ncftp -P 21 -u cmems_med_ogs -p 9J2e+uLU $HOST <<EOF
cd /${PRODUCT}/${dataset}
mkdir ${YEAR}
quit
